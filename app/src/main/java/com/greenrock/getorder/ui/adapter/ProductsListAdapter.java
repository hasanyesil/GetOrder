...
public class ProductsListAdapter extends RecyclerView.Adapter<ProductsListAdapter.Holder> implements Filterable {
    ...
    public ProductsListAdapter(Context context, HashMap<String, Product> productList){
    ...
    public void onBindViewHolder(@NonNull final Holder holder, int position) {
        ...
        holder.priceTextView.setText(String.format("%s TL", productList.get(productName).fiyat));
